    ...
    Assertions.assertThat(symbols).hasSize(2)
        .containsExactlyInAnyOrder(
            PoloniexTicker.builder()
                .symbol("BTC_USDT")
                .open(new BigDecimal("30338.34"))
                .low(new BigDecimal("30308.14"))
                .high(new BigDecimal("32338.91"))
                .close(new BigDecimal("30938.56"))
                .quantity(new BigDecimal("0.1"))
                .amount(BigDecimal.ZERO)
                .tradeCount(1)
                .startTime(1648995780000L)
                .closeTime(1649082121008L)
                .displayName("BTC/USDT")
                .dailyChange(new BigDecimal("0.0198"))
                .bid(new BigDecimal("30338.34"))
                .bidQuantity(new BigDecimal("0.01"))
                .ask(new BigDecimal("30338.35"))
                .askQuantity(new BigDecimal("0.01"))
                .ts(1649082180190L)
                .markPrice(new BigDecimal("30938.57"))
                .build(),
            PoloniexTicker.builder()
                .symbol("ETH_USDT")
                .open(new BigDecimal("1817.69"))
                .low(new BigDecimal("1723.50"))
                .high(new BigDecimal("1897.12"))
                .close(new BigDecimal("1723.50"))
                .quantity(new BigDecimal("2"))
                .amount(BigDecimal.ZERO)
                .tradeCount(5)
                .startTime(1648995780000L)
                .closeTime(1649082121009L)
                .displayName("ETH/USDT")
                .dailyChange(new BigDecimal("-0.0052"))
                .bid(new BigDecimal("1817.70"))
                .bidQuantity(new BigDecimal("0.01"))
                .ask(new BigDecimal("1817.71"))
                .askQuantity(new BigDecimal("0.01"))
                .ts(1649082180190L)
                .markPrice(new BigDecimal("1723.51"))
                .build()
        );
